...
class AddressType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('postalCode', IntegerType::class, ['label' => false])
            ->add('streetAddress', TextType::class, ['label' => false])
            ->add('addressComplement', TextareaType::class, ['label' => false, 'required' => false])
